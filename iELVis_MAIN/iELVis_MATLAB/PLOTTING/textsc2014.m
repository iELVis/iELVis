...
%
% Made to be compatible with post-Matlab 2014 (crudely) by DG
...
% Initial revision
%
% Groppe editted to make it compatible with Matlab2014

function H = textsc2014(x,y,txt)
...
if ~isempty(ch)
    if verLessThan('matlab', '8.0.1')
        set(gcf,'CurrentAxes',min(ch)) %original line DG
    else
        set(gcf,'CurrentAxes',ch(1)); % matlab 2014 compatible version, DG
    end
end
