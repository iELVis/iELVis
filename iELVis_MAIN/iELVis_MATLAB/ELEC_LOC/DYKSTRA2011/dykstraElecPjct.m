...
use_bids=0; % TODO make this a global varialbe and function argument
if use_bids
    
else
    exportFsurfElectrodeLocations(sub,elecReconPath,elecStems,elecNums,elecType,elecHem,VOX2RAS,ctRAS,leptoRAS,pialRAS);
end
